...
"use strict";$(window).on("scroll",function(){$("section").each(function(){var t=$(window).scrollTop();$(this).offset().top-t<200?$(this).addClass("active").change():$(this).removeClass("active")})}),$('a[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var t=$(this.hash);if((t=t.length?t:$("[name="+this.hash.slice(1)+"]")).length)return $("html, body").animate({scrollTop:t.offset().top},700),!1}});var swiper=new Swiper(".swiper-container",{pagination:{el:".swiper-pagination"}});